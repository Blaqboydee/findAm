                 ...
                 {!session ? (
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                      ...
                      className="w-full text-sm sm:w-auto group bg-white text-primary px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold hover:bg-neutral-100 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105  md:text-lg flex items-center justify-center gap-2"
                    >
