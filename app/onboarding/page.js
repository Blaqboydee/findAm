        ...
        <div className="relative z-10 max-w-2xl w-full animate-fadeInUp">
          <div className="bg-white rounded-xl shadow-2xl p-8 md:p-12 text-center">
            ...
            <div className="flex items-center justify-center mb-3 md:mb-6">
              <div className="bg-primary rounded-xl p-3 mr-1 md:mr-3 shadow-lg">
            ...
            {/* Tagline */}
            <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-neutral-900 mb-4">
              Welcome to FindAm
            </h1>
            <p className="text-sm md:text-lg text-neutral-600 mb-10 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <button
                ...
                className="group relative bg-gradient-to-br from-primary to-primary-dark text-white rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
              >
                ...
                <Users className="w-12 h-12 md:w-14 md:h-14 mx-auto mb-4 group-hover:scale-110 transition-transform relative z-10" />
                <h3 className="text-lg md:text-xl font-bold mb-2 relative z-10">I need a service</h3>
                <p className="text-neutral-100 text-sm md:text-sm relative z-10">Find trusted providers near you</p>
              ...
              <button
                ...
                className="group relative bg-gradient-to-br from-secondary to-secondary-dark text-white rounded-2xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
                <Briefcase className="w-12 h-12 md:w-14 md:h-14 mx-auto mb-4 group-hover:scale-110 transition-transform relative z-10" />
                <h3 className="text-lg md:text-xl font-bold mb-2 relative z-10">I offer a service</h3>
                <p className="text-neutral-100 text-sm md:text-sm relative z-10">Grow your business today</p>
                <ArrowRight className="w-6 h-6 mx-auto mt-4 group-hover:translate-x-2 transition-transform relative z-10" />
              </button>
            </div>
            ...
            <button
              ...
              className="mt-8 text-neutral-600 hover:text-primary transition-colors font-medium"
            >
      ...
      {step === 2 && userType && (
        <div className="relative z-10 max-w-2xl w-full animate-fadeInUp">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            {userType === 'user' ? (
              <>
                <h2 className="text-xl md:text-xl lg:text-2xl font-bold text-neutral-900 mb-6 text-center">
            ...
            <div className="text-center space-y-4">
              ...
              <button
                ...
                className={`w-full md:w-auto px-10 py-4 rounded-xl font-bold text-white shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 mx-auto text-lg ${
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            <div className="text-center mb-8">
              {/* <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg ${
               ...
               {/* Logo */}
            <div className="flex items-center justify-center mb-3 md:mb-6">
              <div className="bg-primary rounded-lg p-2 mr-1 md:mr-3 shadow-lg">
                <Search className="w-8 h-8 md:w-10 md:h-10 text-white" />
              </div>
              <span className="text-3xl md:text-4xl font-bold ">
                <span className="text-primary">Find</span>
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <input
                ...
                required
                className="w-full px-4 py-3.5 border-2 border-neutral-200 rounded-xl focus:outline-none focus:border-primary transition-colors text-neutral-900 bg-neutral-50 focus:bg-white text-base"
              />
              <input
                type="email"
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-4 rounded-xl font-bold text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 text-base ${
                  userType === 'user' ? 'bg-gradient-to-r from-primary to-primary-dark' : 'bg-gradient-to-r from-secondary to-secondary-dark'
                }`}
              >
            ...
            <button
              ...
              className="w-full py-3.5 border-2 border-neutral-200 rounded-xl font-semibold text-neutral-800 hover:bg-neutral-50 hover:border-neutral-300 transition-all duration-300 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
            >
